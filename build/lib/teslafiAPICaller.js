    ...
    async ReadTeslaFi() {
        try {
            ...
            if (stVD.battery_range.value !== null) {
                ...
                this.checkAndSetValueNumber(`battery-state.${stVD.battery_range.key}_km`, Math.round(parseFloat(stVD.battery_range.value) * 160.934) / 100, stVD.battery_range.desc, "km");
            }
